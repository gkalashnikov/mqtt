...
#define log_important _begin_output_log_ QMessageLogger("", 0, "", printString(DATETIME_LABEL.append(IMP_LABEL).append(CURRENT_THREAD_INFO).append(_fline_))).critical()
